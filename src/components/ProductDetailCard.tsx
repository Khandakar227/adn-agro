...
export default function ProductDetailCard({ product }: { product: Product }) {
    return (
        <div className="bg-white rounded-xl grid md:grid-cols-2 md:gap-8 w-full p-6 shadow">
                ...
                <div className="flex gap-4 pb-2">
                    {
                        ...
                        <>
                            ...
                            <span className="text-gray-400 font-bold text-xl"> <del>${product.price}</del> </span>
                       </>
                       :
                       <span className="text-gray-400 font-bold text-xl"> ${product.discountPrice} </span>
                    }
                </div>
